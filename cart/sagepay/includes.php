...
$strConnectTo="LIVE"; 	/** Set to SIMULATOR for the Sage Pay Simulator expert system, TEST for the Test Server and LIVE in the live environment **/
$strServerType="SERVER";
if($_SESSION['test']==1)
{
	$strConnectTo="TEST";
	$strServerType="SERVER";
}
$strVendorName=$strConnectTo=="SIMULATOR"?"senfield":"gmkltd"; // Set this value to the Vendor Name assigned to you by Sage Pay or chosen when you applied

$strVirtualDir=""; // Change if you've created a Virtual Directory in IIS with a different name
$orders_email=$sales_email;
...
//Open the VPS database if not already open
